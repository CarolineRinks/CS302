 ...
 * CS302 Spring 2021
 *
 * Encode mode encodes a message specified by the user into a copy 
 * of a P6 PPM image. Decode mode decodes the message out of the image 
...
/* @brief: Populates a vector with pixels and creates a histogram of 12-bit pixel colors. 
 ...
 *		   replacing the LSB of a random pixel with a bit from the character 
 *		   being encoded.
